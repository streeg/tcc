...
source_folder = "/home/guileb/tcc/CryptoSASTRunner/tccResults/desagroup_cc_cg/cc/cc_csvs/#{FOLDER}"
...
Dir.glob(File.join(source_folder, '*.csv')).each do |csv_file|
  apk_name = File.basename(csv_file.gsub('.apk-report-extended', ''), File.extname(csv_file))
