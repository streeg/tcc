...
COGNICRYPT_MERGED_PATH = '/home/guileb/tcc/CryptoSASTRunner/tccResults/crypto-lib-merged-result/libscout-cognicrypt/security-merged-results/*.json'.freeze # change_path_as_needed
