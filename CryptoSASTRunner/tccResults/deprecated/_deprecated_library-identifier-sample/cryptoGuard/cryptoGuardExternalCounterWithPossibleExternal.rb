...
SECURITY_PATH = '/home/guileb/tcc/CryptoSASTRunner/tccResults/libscout-result/crypto_guard_security_with_library'
SECURITY_NAME_PATH = 'cryptoGuard_security_external_counter_report_with_possible_libraries.csv'
...
LOADED_PATH = SECURITY_PATH
LOADED_NAME_PATH = SECURITY_NAME_PATH
...
loaded_path.each do |lib_file_name|
  ...
  lib_file_data['Issues'].each do |lib|
    ...
    possible_external += 1 if lib.include?('PossibleExternalLibrary')
  end
