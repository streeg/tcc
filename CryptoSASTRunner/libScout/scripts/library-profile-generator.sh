...
LIBSCOUT_ROOT="/home/guileb/tcc/LibScout-master"                      # path to the LibScout root directory
LIBSCOUT="$LIBSCOUT_ROOT/build/libs/LibScout.jar"
ANDROID_SDK="/home/guileb/Android/Sdk/platforms/android-33/android.jar"                        # argument: path to Android SDK
