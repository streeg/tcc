...
A ferramenta CogniCrypt é um software livre, que permite a análise em tempo real de código e também a criptografia de dados. Se baseia em regras bem definidas construídas com o auxílio da línguagem de domínio bem definido CrySL. É desenvolvida como um projeto de pesquisa, integrada à IDE Eclipse e disponibilizada sob a licença GNU GPL. 
CrySL especifica boas práticas para o uso correto de APIs criptográficas. O CogniCrypt já possui algumas \textit{CrySL Rules} (Regras CrySL) compatíveis com a arquitetura criptografica java \textit{(JCA - Java Cryptography Architecture)}. Seguindo essas regras e especificações, o CogniCrypt é capaz de identificar e sugerir melhorias para a segurança de um código inseguro. 
